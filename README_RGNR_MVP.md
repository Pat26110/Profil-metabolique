...
## Contenu
- `data/rgnr_questions_v1.json` : 49 questions normalisées
- `data/rgnr_profiles_v1.json` : 15 profils modélisés
- `data/rgnr_calibration_cases_v1.json` : 24 cas de test
- `src/lib/rgnr_scoring_engine_v1.ts` : squelette TypeScript du moteur
